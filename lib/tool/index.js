...
class DataLegalityChecker {
    ...
    __inspect_0(workPack) {
        ...
        if (workPack["db"]) {
            if (Object.prototype.toString.call(workPack["db"]) != "[object Object]") {
                throw new Error("invalid parameter");
            } else {
                if (Object.keys(workPack["db"]).includes("name")) {
                    if (Object.prototype.toString.call(workPack["db"]["name"]) != "[object String]") {
                        throw new Error("invalid parameter");
                    }
                } else {
                    throw new Error("invalid parameter");
