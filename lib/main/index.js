const { __convert_work, init_config, query_done, DataLegalityChecker } = require("../tool");
...
var { db, db_url, config_symbol, worker } = require("./Symbol");
...
class nayo {
    constructor(options, config) {
        ...
        this[worker] = new Worker(this[db_url], this[db], this[config_symbol]);
    }
